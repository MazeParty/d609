...
from transformjson import transform
...
#3. Now that all JSON data in S3 is legible, we will make the SQL Landing Zone Tables executing via copy paste in AWS Athena 
